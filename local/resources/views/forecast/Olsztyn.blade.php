...
@section('content')
    ...
    <div class="col-sm-12">
        ...
        <div class="content">
            <ul>
                <li><a href="{{action('Forecast@Olsztyn')}}">Olsztyn</a></li>
                <li><a href="{{action('Forecast@London')}}">Londyn</a></li>
                <li><a href="{{action('Forecast@Rzeszow')}}">Rzeszow</a></li>
            </ul>

            <?php $json=file_get_contents('https://api.forecast.io/forecast/22d2bd3c5dab42a265e7c10415f821e3/'.$lon.$lan.'?lang=pl&units=si');
